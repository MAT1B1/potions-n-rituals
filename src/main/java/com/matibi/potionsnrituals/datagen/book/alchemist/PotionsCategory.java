...
public class PotionsCategory extends CategoryProvider {
    ...
    public static final String ID = "potions_category";
    ...
    protected void generateEntries() {
        ...
        p("darkness", "Shrouds enemies in darkness.",
                ...
                """
                    ...
                    \\
                    \\
                    It is not a shadow... It is alive. It isolates you, severing your tie to the world above until you are nothing but a heartbeat in the dark.
                    \\
                    \\
                    A lone vibration.
                    \\
                    \\
                    A signal for the creature of the **Deep Dark**
                    """, true);
    ...
    protected String categoryDescription() {
        return "The power of alchemy.";
    }

    @Override
    protected BookIconModel categoryIcon() {
        return BookIconModel.create(Items.LINGERING_POTION);
    }
