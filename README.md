...
A Fabric mod that **enhance alchemy** in Minecraft.

New potions, effects, alchemical stones, imbued weapons, rituals, and immersive mechanics, expanding far beyond simple brewing.

This Mod is a rework of **The Alchemist's Touch**
...
| Poison          | - Poisonous Potato<br/>- Poisonous Carrot<br/>- Poisonous Beetroot | Awkward      |
...
| Midas Benediction    | Alchemist                 | Materia Prima          | Long         |
| Ignition             | Fire Resistance           | Fermented Spider Eye   | Long         |
| Acidity              | Poison                    | Rotten Flesh           | Long, Strong |
| Petrification        | Turtle Master             | Obsidian               | Long, Strong |
| Medusa Benediction   | Strong Petrification      | Materia Prima          | Long         |
| Zeus Benediction     | Stun                      | Materia Prima          | Long         |
| Active Teleportation | Teleportation             | Sulfur Ball            | Long         |
...
| Acidity              | Harmful    | Deals continuous damage to entities and melts weak blocks in the terrain.                                                                                                      |
| Ignition             | Harmful    | Sets the entity on fire and allows the player to throw fireballs on command. Smelts blocks when used on terrain.                                                               |
...
| Thorns               | Beneficial | Same as the enchantement, damage whoever attacked you.                                                                                                                         |
| Brain Washing        | Harmful    | Rallies undead mobs to attack your enemies, scrambles villager prices, and disorients the player.                                                                              |
| Frost                | Harmful    | Inflicts continuous cold damage, slows movement drastically, and freezes nearby water sources when used on terrain.                                                            |
| Alchemist            | Beneficial | Instantly transmutes coal/charcoal items into their gold variants.                                                                                                             |
| Death                | Harmful    | Inflicts massive, unavoidable damage that rapidly consumes health until death. Don't work to full efficiency on bosses.                                                        |
...
| Resurrection         | Beneficial | Acts as a Totem of Undying, cheating death and teleporting the player to an anchor point when used on terrain.                                                                 |
...
| Unstable             | Harmful    | Grants random negative effects andd the entity have a high chance to explode.                                                                                                  |
...
| Dwarfism             | Neutral    | Drastically reduces player size and reach, allowing you to sneak into tiny spaces.                                                                                             |
| Photosynthesis       | Beneficial | Gradually restores the hunger bar as long as the entity is in direct sunlight.                                                                                                 |
| Oblivion             | Harmful    | Randomly drop a portion (25%) of the entity's inventory.                                                                                                                       |
...
| Zeus Benediction     | Active     | Summons lightning strikes on melee targets or manually via keybind.                                                                                                            |
| Medusa Benediction   | Active     | Petrifies any entity that looks directly at you.                                                                                                                               |
| Active Teleportation | Active     | Instantly teleports the player to the exact block in their crosshair on command. <br/>                                                                                         |
| Pregnant             | Neutral    | Triggers a gestation period that eventually spawns baby mobs.                                                                                                                  |
| Love                 | Active     | Allows the player to breed any compatible species of animals instantly giving the affected entity the status effect Pregnant (Ear me out... not as weird as it seems... ok ?). |
| Midas Benediction    | Neutral    | Transforms the affected entity's equipped armors and weapons into their golden versions.                                                                                       |
...
| Empathy              | Neutral    | Links the affected entity to its target, therefore, it receives a portion of the damage dealt.                                                                                 |
...
- **Pour a potion (Splash and Lingering potion included)** into a vanilla cauldron so you can mix them together.
- **Extract**: 
  - right-click with a glass bottle to bottle the mixture back out.
  - right-click with arrows to create tipped arrows imbued with the cauldron's effects.
  - right-click with an Alchemical Stone to charge it from the cauldron's contents (must be a available alchemical stone).
- Be careful, if you make an unstable mixture or add an unstable potion to the cauldron, it will explode.
...
|---------------|-----------------------------------------------------------------------------------------|
| Acidity       | Destroys weak blocks (hardness < 50) in a radius. Strong: larger radius, any hardness   |
| Petrification | Converts blocks to cobblestone (or sandstone for sand). Strong: converts to **bedrock** |
| Alchemist     | Transmutes coal blocks/ore into gold blocks/ore                                         |
| Ignition      | Smelts blocks like a furnace                                                            |
| Giant         | Grows crops to maturity                                                                 |
| Resurrection  | Grants Resurrection effect and sets teleport anchor point                               |
| Frost         | Freezes nearby water sources into ice in a radius. Strong: larger radius                |
...
- **Food Imbuing**: Combine any food item with one or more potions in a Crafting Table. Eating applies all imbued effects.
...
> Pattern will be shown in-game with a book
...
| Spirit Mirror            | Teleports to the Spirit Dimension (6 uses)                                                                             |
| Decoy                    | Distracts hostile mobs                                                                                                 |
| Gauntlet of the Absolute | Stores up to 5 alchemical stone effects; cycle & apply on terrain                                                      |
| Invisibility Ring        | Grants invisibility while held                                                                                         |
| Invisibility Cloak       | Wearable chestplate granting invisibility +2 armor                                                                     |
| Phoenix Quill            | Write and execute any command at the cost of your health and xp (still pretty op if you know what you are doing)       |
| Lock                     | Locks any chest or container (people might still steal your stuff as the container just gets 10 times harder to break) |
| Key                      | Unlocks a matching locked container (consumed on use)                                                                  |
| Capture Sphere           | Thrown projectile that captures mobs inside or releases them                                                           |
...
|--------------------------------|----------|--------------------------------------------------|
| Active Effect / Cycle Gauntlet | Left Alt | Trigger active effects or cycle Gauntlet effects |
